package sg.edu.np.weatherforecast;
...
public class Main2Activity extends AppCompatActivity {
    ...
    public void onCreateClick(View v){
        final EditText etPassword = (EditText) findViewById(R.id.editText_CreateP);
        final EditText etUserName = (EditText) findViewById(R.id.editText_CreateN);
